...
<body <?php body_class(); ?>>
  ...
  <div id="project-print">
    ...
    <?php echo $hero_image['url']; ?>

      <img class="pp-time" src="<?php echo get_template_directory_uri(); ?>/assets/img/timer.png" alt="Maker Camp Project Time Icon" />
      <h4><?php echo $time; ?></h4>
      <h5>TO COMPLETE</h5>

      <h2>WHAT WILL YOU MAKE?</h2>
      <div class="pp-learn"><?php echo $what_will_you_learn; ?>


    <section class="pp-materials text-center">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              ...
              <?php if (!empty($image_1)) { ?>
                <a class="pp-step-img" href="<?php echo $image_1['url']; ?>">
                  <div style="background-image: url(<?php echo $image_1['url']; ?>);"></div>
                </a>
              <?php } ?>

              <?php if (!empty($image_2)) { ?>
                <a class="pp-step-img" href="<?php echo $image_2['url']; ?>">
    ...
    <?php if( have_rows('author', $parent_id) ): ?>
      ...
      <section class="pp-author container">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6">
            ...
            <?php if (!empty($author_url)) { echo '<a href="' . $author_url . '">'; } ?>
              <?php if (!empty($image)) { 
                echo '<div class="pp-author-img img-circle" style="background-image: url(' . $image["url"] . ');"></div>';
              } else {
                echo '<div class="pp-author-img" style="background-image: url(' . get_template_directory_uri() .'/assets/img/Makey_sml.svg"></div>';
              } ?>
