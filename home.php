  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="#hero" data-content="Looks like you are already signed up!" data-placement="top" data-trigger="manual"
           class="read-more sign-in-trigger">Sign up for fun alerts</a>
      </div>
      <div class="col-sm-6">
        ...
        <ul class="read-more-list">
          <li>
            <a href="<?php bloginfo('url'); ?>/map" class="hide-in-mobile read-more">Find a campsite in your
              neighborhood</a>
          </li>
          <li>
    ...
    <ul class="physical-campsites-description-list">
      ...
      <li>
        ...
        <?php if (!empty($fourth_section_first_link)) : ?>
          ...
          echo $fourth_section_first_link; ?>" class="read-more">Find out if there’s one close to you, and join the
            fun</a>
        <?php endif;
        ...
        if (!empty($fourth_section_second_link)) :
          ?>
          <a href="<?php bloginfo('url');
          echo $fourth_section_second_link; ?>" class="read-more">Host a camp</a>
        <?php endif; ?>
